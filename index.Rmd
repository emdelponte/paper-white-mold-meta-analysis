---
title: 'Reproducible report: <br/> Meta-analysis of relationships in soybean white
  mold epidemic data'
output:
  html_document:
    css: my-style.css
  ...
  word_document:
    toc: yes
date: "Created: 2016-10-01 - Last update: `r Sys.Date()`"
---
...
The raw data was organized in the long or [tidy format](http://garrettgman.github.io/tidying/) where each treatment (observation) in a fungicide trial (hereafter study) is placed in its row and each variable in its column. Let's no load the data and group by study for data frames separated for each relationship.
